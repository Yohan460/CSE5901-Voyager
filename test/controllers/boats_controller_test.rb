...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { Name: @boat.Name, NumberOfRooms: @boat.NumberOfRooms } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { Name: @boat.Name, NumberOfRooms: @boat.NumberOfRooms } }
